...
import { costSMSCmncmccCreate } from '../../../../constants/contextpath/admin/costmanagement/CostManagement';
function CostSmscMncmccCreate() {
    const navigate = useNavigate();
    const dispatch = useDispatch();

    // Set the page name in the Redux store
    const pagename = { pagename: 'Cost SMSC MCC & MNC Create' };
    ...
    const [formData, setFormData] = useState({
        ...
        mcc: '',
        mnc: '',
        smscid: '', // Changed from carriername to smscid
        dial_in_code: '',
    });
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData, costSMSCmncmccCreate)
            .then((response) => {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Cost Management &gt; Cost SMSC MCC & MNC Create</p>
            </div>
            <div className="md:px-[23px] px-[8px]">
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <h1 className="text-xl font-semibold admin-table-text text-table-text">Cost SMSC MCC & MNC Create</h1>
                        </div>
                        {error && (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Create Cost Smsc Mnc mcc</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default CostSmscMncmccCreate;
