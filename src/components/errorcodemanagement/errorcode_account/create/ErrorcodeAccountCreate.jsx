...
import { errorcodeAccountCreate } from '../../../../constants/contextpath/admin/errorcodemanagement/Errorcodemanagement';
import { errorcodePlatformGetAll } from '../../../../constants/contextpath/admin/errorcodemanagement/Errorcodemanagement';
function ErrorcodeAccountCreate() {
    const dispatch = useDispatch();

    // Set the page name in the Redux store
    const pagename = { pagename: 'Errorcode Account Create' };
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData, errorcodeAccountCreate)
            .then((response) => {
                Setsuccess('Errorcode Account Created successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
    ...
    // Function to decode account name (assuming account names are encoded)
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Errorcode Management &gt; Errorcode Account Create</p>
            </div>
                ...
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <div>
                                <h1 className="text-xl font-semibold admin-table-text text-table-text">Errorcode Account Create</h1>
                            </div>
                        </div>
                        {error && (
...
export default ErrorcodeAccountCreate;
