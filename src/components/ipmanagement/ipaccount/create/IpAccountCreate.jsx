...
import { ipAccountCreate } from '../../../../constants/contextpath/admin/ipmanagement/IpManagement';
function IpAccountCreate() {
  ...
  const handleSubmit = (e) => {
    ...
    connectAPIViaPost(formData, ipAccountCreate)
      .then((response) => {
...
export default IpAccountCreate;
