...
import { ipCustomerUpdate } from '../../../../constants/contextpath/admin/ipmanagement/IpManagement';
function IpCustomerEdit() {
  const dispatch = useDispatch();
  const location = useLocation();
  const pagename = { pagename: 'ip Account Edit' };
  dispatch(pagenamechange(pagename));
  const ip = location.state?.ipCustomer;
  ...
  const [formData, setFormData] = useState({
    ...
    ipcustomer_id: ip?.ipcustomer_id || '',
    ip: ip?.ip || '',
  ...
  const handleSubmit = (e) => {
    ...
    connectAPIViaPost(formData, ipCustomerUpdate)
      .then((response) => {
        ...
        <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
          <main>
            ...
            <form onSubmit={handleSubmit} className="admin-inner-body2 rounded pt-2 pb-8 mb-4 flex flex-col my-2">
              ...
              <div className="">
                <Button>Update Senderid Customer</Button>
