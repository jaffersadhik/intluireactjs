...
import { priceAccountMncmccCreate } from '../../../../constants/contextpath/admin/pricemanagement/PriceManagement';
function PriceAccountMncMccCreate() {
    const dispatch = useDispatch();

    // Set the page name in the Redux store
    const pagename = { pagename: 'Price Account Mnc Mcc Create' };
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData,priceAccountMncmccCreate ) // Replace with the actual endpoint
            .then((response) => {
                Setsuccess('Price account Mnc Mcc created successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Cost Management &gt; Price Account Mnc Mcc  Create</p>
            </div>
                ...
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <div>
                                <h1 className="text-xl font-semibold admin-table-text text-table-text">Price Account Mnc Mcc  Create</h1>
                            </div>
                        </div>
                        {error && (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Create Price Account Mnc Mcc</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default PriceAccountMncMccCreate;
