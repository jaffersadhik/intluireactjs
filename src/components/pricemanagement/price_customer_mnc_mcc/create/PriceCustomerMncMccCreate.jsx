...
import { priceCustomerMncmccCreate } from '../../../../constants/contextpath/admin/pricemanagement/PriceManagement';
...
function PriceCustomerMncMccCreate() {
    const dispatch = useDispatch();

    const pagename = { pagename: 'Price Customer Mnc Mcc Create' };
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData,priceCustomerMncmccCreate ) // Replace with the actual endpoint
            .then((response) => {
                Setsuccess('Price Customer Mnc Mcc created successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Price Management &gt; Price Customer Mnc Mcc Create</p>
            </div>
                ...
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <div>
                                <h1 className="text-xl font-semibold admin-table-text text-table-text">Price Customer Mnc Mcc Create</h1>
                            </div>
                        </div>
                        {error && (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Create Price Customer Mnc Mcc</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default PriceCustomerMncMccCreate;
