...
import { priceCustomerMncmccUpdate } from '../../../../constants/contextpath/admin/pricemanagement/PriceManagement';
function PriceCustomerMncMccEdit() {  // Updated component name
    const dispatch = useDispatch();
    const location = useLocation();
    const PriceCustomermncmcc = location.state.PriceCustomermncmcc;  // Changed costsmscview to PriceAccount

    const pagename = { pagename: 'Price Customer Mnc Mcc Edit ' };  // Updated page name
    ...
    const [formData, setFormData] = useState({
        price_id: PriceCustomermncmcc.price_id || '',
        price: PriceCustomermncmcc.price || '',
        customername: PriceCustomermncmcc.customername || '',
        dial_in_code: PriceCustomermncmcc.dial_in_code || '',
        mcc: PriceCustomermncmcc?.mcc || '',
        mnc: PriceCustomermncmcc?.mnc || '',
    });
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData,priceCustomerMncmccUpdate)  // Updated the API URL
            .then((response) => {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Price Management &gt; Price Customer Mnc Mcc Edit</p> {/* Updated breadcrumb */}
            </div>
                ...
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <div>
                                <h1 className="text-xl font-semibold admin-table-text text-table-text">Price Customer Mnc Mcc Edit</h1>  {/* Updated title */}
                            </div>
                        </div>
                        {error && (
...
export default PriceCustomerMncMccEdit;  // Exporting the updated component
