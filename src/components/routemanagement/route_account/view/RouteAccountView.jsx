...
function RouteAccountView() {
    const dispatch = useDispatch();

    const pagename = { pagename: 'Route Account View' };
    dispatch(pagenamechange(pagename));
    const location = useLocation();
    const RouteAccount = location.state?.RouteAccount; // Get the RouteAccount data from the location state
    ...
    return (
        <div className='w-full h-auto min-h-screen admin-inner-body1 pb-10 bg-gray-100'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Route Management &gt; Route Account View</p>
            </div>
            <div className="md:px-[23px] px-[8px]">
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl shadow-md">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <h1 className="text-xl font-semibold admin-table-text">Route Account View</h1>
                        </div>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 admin-table-text">
                                    ...
                                    <div className="p-4 border rounded-lg shadow-sm">
                                        ...
                                        <p className="mb-2"><strong>Dial-In Code:</strong> {RouteAccount.dial_in_code || 'N/A'}</p>
                                        <p className="mb-2"><strong>Account Name:</strong> {decodeaccount(RouteAccount.accountname)}</p> 
...
export default RouteAccountView;
