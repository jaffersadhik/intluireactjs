...
import { routeCustomerEdit } from '../../../../constants/contextpath/admin/routemanagement/RouteManagement';
function RouteCustomerEdit({ match }) {
    ...
    useEffect(() => {
        dispatch(pagenamechange({ pagename: 'Route Customer Edit' }));
    }, [dispatch]);
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData, routeCustomerEdit)
            .then((response) => {
                Setsuccess('Route Customer Updated successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Route Management &gt; Route Customer Edit</p>
            </div>
                ...
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <div>
                                <h1 className="text-xl font-semibold admin-table-text text-table-text">Route Customer Edit</h1>
                            </div>
                        </div>
                        {error && (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Update Route Customer</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default RouteCustomerEdit;
