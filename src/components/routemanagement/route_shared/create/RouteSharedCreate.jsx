...
import { routeSharedSave } from '../../../../constants/contextpath/admin/routemanagement/RouteManagement';
function RouteSharedCreate() {
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData,routeSharedSave )
            .then((response) => {
                Setsuccess('Route Shared created successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
                    ...
                    <main>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Create Route Shared</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default RouteSharedCreate;
