...
import { routeSharedEdit } from '../../../../constants/contextpath/admin/routemanagement/RouteManagement';
function RouteSharedEdit({ match }) {
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData,routeSharedEdit )
            .then((response) => {
                Setsuccess('Route Shared Updated successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
                    ...
                    <main>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Update Route Shared</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default RouteSharedEdit;
