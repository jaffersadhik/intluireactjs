...
import { senderIdAccountUpdate } from '../../../../constants/contextpath/admin/senderidmanagement/SenderidManagement';
function SenderidAccountEdit() {
  const navigate = useNavigate();
  const location = useLocation();
  const senderid = location.state?.senderidAccount;
  ...
  const [formData, setFormData] = useState({
    ...
    accountname: senderid?.accountname || '',
    senderid: senderid?.senderid || '',
    accountsenderid_id : senderid?.accountsenderid_id || '',
  });
  ...
  const handleSubmit = (e) => {
    ...
    connectAPIViaPost(formData, senderIdAccountUpdate)
      .then((response) => {
        ...
        <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
          <main>
            ...
            <form onSubmit={handleSubmit} className="admin-inner-body2 rounded pt-2 pb-8 mb-4 flex flex-col my-2">
              ...
              <div className="">
                <Button>Senderid Account Update</Button>
...
export default SenderidAccountEdit;
