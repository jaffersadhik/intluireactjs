...
import { senderIdCustomerUpdate } from '../../../../constants/contextpath/admin/senderidmanagement/SenderidManagement';
function SenderidCustomerEdit() {
  const dispatch = useDispatch();
  const location = useLocation();
  const pagename = { pagename: 'Senderid Account Edit' };
  dispatch(pagenamechange(pagename));
  const senderid = location.state?.senderidCustomer;
  ...
  const [formData, setFormData] = useState({
    ...
    customersenderid_id: senderid?.customersenderid_id || '',
    senderid: senderid?.senderid || '',
    customername : senderid?.customername || '',
  });
  ...
  const handleSubmit = (e) => {
    ...
    connectAPIViaPost(formData, senderIdCustomerUpdate)
      .then((response) => {
        ...
        <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
          <main>
            ...
            <form onSubmit={handleSubmit} className="admin-inner-body2 rounded pt-2 pb-8 mb-4 flex flex-col my-2">
              ...
              <div className="">
                <Button>Senderid Customer Update</Button>
...
export default SenderidCustomerEdit;
