...
import { senderIdSharedCreate } from '../../../../constants/contextpath/admin/senderidmanagement/SenderidManagement';
function SenderidsharedCreate() {
  ...
  const handleSubmit = (e) => {
    ...
    connectAPIViaPost(formData, senderIdSharedCreate)
      .then((response) => {
        ...
        <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
          <main>
            ...
            <form onSubmit={handleSubmit} className="admin-inner-body2 rounded pt-2 pb-8 mb-4 flex flex-col my-2">
              ...
              <div className="">
                <Button>Senderid shared Create</Button>
...
export default SenderidsharedCreate;
