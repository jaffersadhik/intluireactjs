...
function SmscCreate() {
    ...
    const pagename = { pagename: 'SMSC Create' };
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(updatedFormData, smscSave)
            .then((response) => {
                Setsuccess('SMSC created successfully');
                Seterror('');
            })
            .catch((error) => {
                if (error.response) {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">SMSC Management &gt; SMSC Create</p>
            </div>
                ...
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <div>
                                <h1 className="text-xl font-semibold admin-table-text text-table-text">SMSC Create</h1>
                            </div>
                        </div>
                        {error && (
