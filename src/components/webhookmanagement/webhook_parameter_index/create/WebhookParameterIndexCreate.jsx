...
import { webhookParameterSave } from '../../../../constants/contextpath/admin/webhookmanagement/WebhookManagement';
function WebhookParameterIndexCreate() {
    const dispatch = useDispatch();
    const pagename = { pagename: 'Webhook Parameter Index Create' };
    dispatch(pagenamechange(pagename));

    const [error, setError] = useState("");
    const [success, setSuccess] = useState("");

    // Only include indexnumber and parametername in formData
    const [formData, setFormData] = useState({
        indexnumber: '', // New field
        parametername: '', // New field
    });
    ...
    const handleSubmit = (e) => {
        ...
        connectAPIViaPost(formData, webhookParameterSave)
            .then((response) => {
    ...
    return (
        <div className='w-[100%] h-auto min-h-screen admin-inner-body1 pb-10'>
            <div className="md:pl-[33px] pl-[20px] md:pt-[10px] pt-[10px] mb-[10px] flex">
                <p className="text-admin-color2">Webhook Management &gt; Webhook Parameter Index Create</p>
            </div>
            <div className="md:px-[23px] px-[8px]">
                <div className="admin-inner-body2 md:px-[30px] px-[10px] py-[20px] rounded-xl">
                    <main>
                        <div className='flex justify-between items-center mb-4'>
                            <h1 className="text-xl font-semibold admin-table-text text-table-text">Webhook Parameter Index Create</h1>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <Button type="submit">Webhook Parameter Index Create</Button>
                            </div>
                        </form>
                    </main>
                </div>
...
export default WebhookParameterIndexCreate;
